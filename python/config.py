...
LLM_REQUEST_TIMEOUT_SECONDS = float(os.environ.get("LLM_REQUEST_TIMEOUT_SECONDS", 300.0))
SLOT_REQUEST_TIMEOUT_SECONDS = float(os.environ.get("SLOT_REQUEST_TIMEOUT_SECONDS", 10.0))
